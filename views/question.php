...
<li class="question parent collapsed <?php echo $essay_flag == 'true' ? 'essay_type' : ''; echo ' '; echo $multiple_choice_flag == 'true' ? 'multiple_choice' : '' ?>" data-path="<?php echo esc_attr($path['id']) ?>" data-question="<?php echo esc_attr($question['id']) ?>" data-sort="<?php echo esc_attr(wp_create_nonce('sort_questions')); ?>">
	
	<textarea class="question title" name="quizu_all_questions[<?php echo esc_attr($path['id']) ?>][questions][<?php echo esc_attr($question['id']) ?>][title]" placeholder=""><?php echo esc_html($question['title']) ?></textarea>
	<input class="question id" type="hidden" name="quizu_all_questions[<?php echo esc_attr($path['id']) ?>][questions][<?php echo esc_attr($question['id']) ?>][id]" value="<?php echo esc_attr($question['id']) ?>" placeholder="">
