...
?>
	...
	<div class="quizu_widget <?php echo $question['flags']['multiple_choice_flag'] == 'true' ? 'multiple_choice' : '' ; echo ' '; echo isset($quizu_in_sidebar) ? 'sidebar' : '' ?>" data-id="<?php echo $linked_quiz ?>" data-done="<?php echo wp_create_nonce( 'done' ) ?>" data-first="<?php echo wp_create_nonce( 'first' ) ?>" data-email="<?php echo wp_create_nonce( 'email' ) ?>">
